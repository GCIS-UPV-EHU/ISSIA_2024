...
sudo k3s kubectl create -f /home/issia/Kubernetes_dashboard/dashboard_namespace.yaml
...
sudo k3s kubectl create -f /home/issia/Kubernetes_dashboard/dashboard.admin-user.yml -f /home/issia/Kubernetes_dashboard/dashboard.admin-user-role.yml
sleep 2
sudo k3s kubectl -n kubernetes-dashboard create token admin-user > /home/issia/Kubernetes_dashboard/dashboard_token.txt
