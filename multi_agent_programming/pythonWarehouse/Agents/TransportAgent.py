...
class TransportAgent(MFCResourceAgent):
    ...
    def __init__(self, jid, password, battery=99):
        print("[" + jid + "] entering init")

        self.ready = False
        MFCResourceAgent.__init__(self, jid, password)
        ...
        print("[" + jid + "] battery level: " + str(self.battery) + "%")
